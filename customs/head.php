...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <ul id="tnb">
            ...
            <li><a href="<?php echo G5_BBS_URL ?>/write.php?bo_table=point2coin">포인트를엽전으로변환</a></li>
            <li><a href="<?php echo G5_BBS_URL ?>/qalist.php">엽전구매</a></li>
...
<div id="wrapper">
    <div id="aside">
        <?php echo outlogin('streaming'); // 외부 로그인  ?>
